...
import { linkBoardType } from "@/sanity/schemaTypes/linkBoardType";
...
export const schemaTypes: SchemaTypeDefinition[] = [mixType, programmeType, artistType, editorialStoryType, authorType, topicType, linkBoardType, siteSettingsType];
